 ...
 * 描述：     异常枚举
 */
public enum BookAdminExceptionEnum {
    ...
    NO_ENUM(1019, "未找到对应的枚举"),
    NO_ORDER(1020, "订单不存在"),
    NOT_YOUR_ORDER(1021, "订单不属于你"),
    WRONG_ORDER_STATUS(1022, "订单状态不符"),
    SYSTEM_ERROR(2000, "系统异常，请从控制台查看具体错误信息");
    ...
    BookAdminExceptionEnum(Integer code, String msg) {
        this.code = code;
        this.msg = msg;
    }
